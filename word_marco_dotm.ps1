...
param(
    [string]$InputPath = "C:\Git\MendropEngineering\HandHPS.dotx",
    [string]$OutputPath = "",
    [string]$TemplatePath = "C:\Git\MendropEngineering\HandHPS.dotx",
...
$script:DefaultTemplatePath = Join-Path $script:ScriptDirectory "HandHPS.dotm"  #change here "HandHPS.dotx or tm or cx"
